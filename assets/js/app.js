...
(function () {
  ...
  var I18N = {
    pt: {
      ...
      typeOdd:'heading/3 tem tracking POSITIVO de +2px, e label/tag tem +10px. Ambos são deliberados — não normalize para zero.',
      iconT:'Ícones',
      ...
      dlDesign:'DESIGN.md', dlDesignD:'A referência de estilo em markdown pronta para usar num agente de IA.',
    ...
    en: {
      ...
      typeOdd:'heading/3 has POSITIVE +2px tracking, and label/tag has +10px. Both are deliberate — do not normalise them to zero.',
      iconT:'Icons',
      ...
      dlDesign:'DESIGN.md', dlDesignD:'The style reference in markdown, ready to use in an AI agent.',
      secPractices:['AI & Data','Digital Solutions','Cloud Computing','SAP','SAP Concur','Business Agility'],
